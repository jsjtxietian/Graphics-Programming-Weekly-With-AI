Unknown Date: [[video] Grass Fields in Unity URP! Procedurally Generate Blades with Compute Shaders | Game Dev Tutorial](https://www.youtube.com/watch?v=DeATXF4Szqo&feature=youtu.be)
